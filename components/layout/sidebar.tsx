...
import { Scroll, Users, Dice6, Menu, X, GraduationCap } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-medieval-brown to-dark-brown text-parchment transform ${
